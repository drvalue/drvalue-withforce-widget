  ...
  function run() {
    ...
    btn.innerHTML = `
      <svg width="100%" height="100%" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M15 29.0625C18.6994 29.0625 21.3669 28.9619 23.1294 28.8581C25.1594 28.7394 26.8031 27.2281 26.9756 25.1581C27.0894 23.7912 27.1875 21.885 27.1875 19.375C27.1875 16.865 27.0894 14.9587 26.975 13.5919C26.8031 11.5219 25.1594 10.0106 23.1294 9.89187C21.3669 9.78812 18.6994 9.6875 15 9.6875C11.3006 9.6875 8.63312 9.78812 6.87063 9.89187C4.84063 10.0106 3.19688 11.5219 3.02438 13.5919C2.91063 14.9587 2.8125 16.8644 2.8125 19.375C2.8125 21.8856 2.91063 23.7913 3.025 25.1588C3.19688 27.2281 4.84063 28.7394 6.87063 28.8587C8.63312 28.9619 11.3006 29.0625 15 29.0625Z" fill="currentColor"/>
